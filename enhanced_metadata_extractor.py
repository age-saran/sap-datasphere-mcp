...
class EnhancedDatasphereClient:
    ...
    def parse_odata_metadata_xml_full(self, xml_content: str) -> Dict[str, Any]:
        """Parse OData $metadata XML for columns AND variables/filters.
        ...
        This method surfaces all three.
        """
        namespaces = {
        ...
        try:
            ...
            for entity_type in root.findall('.//edm:EntityType', namespaces):
                for prop in entity_type.findall('edm:Property', namespaces):
                    ...
                    # SAP semantic annotations (label, aggregation-role, semantics)
    ...
    def parse_odata_metadata_xml(self, xml_content: str) -> List[Dict[str, Any]]:
        ...
        Prefer parse_odata_metadata_xml_full() to also receive variables and
        filter annotations introduced by Datasphere wave 2026.10.
        """
        return self.parse_odata_metadata_xml_full(xml_content).get('columns', [])
